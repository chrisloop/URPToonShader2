...
void OutlineObject_float(float2 UV, float OutlineThickness, float DepthSensitivity, float NormalsSensitivity, out float3 Original, out float Outline, out float AlphaDetail, out float SceneDepth)
{
...
void AlphaDetail_float(float2 UV, float OutlineThickness, out float3 Original, out float Detail)
{
    ...
    Detail = sqrt(dot(colorFiniteDifference0.a, colorFiniteDifference0.a) + dot(colorFiniteDifference1.a, colorFiniteDifference1.a));
